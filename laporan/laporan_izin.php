...
<?php
$sql = "select * from tb_balasan_izin join tb_pemohon on tb_balasan_izin.nik_pemohon = tb_pemohon.nik_pemohon where tb_balasan_izin.tanggal_surat between '$_POST[dari_tgl]' AND '$_POST[sampai_tgl]' order by id_balasan desc";
...
<td> <center>Surat Permohonan Izin Riset</center></td>
