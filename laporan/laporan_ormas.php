...
<?php
$sql = "select * from tb_balasan_ormas join tb_pemohon on tb_balasan_ormas.nik_pemohon = tb_pemohon.nik_pemohon where tb_balasan_ormas.tanggal_surat between '$_POST[dari_tgl]' AND '$_POST[sampai_tgl]' order by id_balasan desc";
...
<td> <center>Surat Permohonan Pembentukan Ormas </center></td>
