 ...
 <table border="0">
  <tr>
    ...
    <tr>
      ...
      <td>
      <form action ="<?php echo base_url()?>email/email_izin" method="POST">
  ...
  <!-- <button type="submit" class="btn btn-sm btn-warning"> <i class="fa fa-paper-plane"> </i> &nbsp; Kirim ke email pemohon </button> -->
 ...
 <div id="data-izin" align="center">
  ...
  <tr>
   ...
   <img src="<?php echo base_url().'/file/syarat_izin/'.$foto ?>" width="140px" height="">
    ...
    <td>
      <p style="font-family: Times New Roman, Times, serif; ; color: black; font-size: 12px; " align="center"><b>
