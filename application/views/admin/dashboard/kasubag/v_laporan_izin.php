...
<h3>Cetak Laporan Permohonan Izin Riset</h3>
<hr>

<div class="col-md-12 col-sm-12 col-xs-12">
<div class="x_panel">

	<h4> <i class="fa fa-book"> </i> &nbsp; Laporan  Surat Permohonan Izin Riset </h4>
	<br>

    <form method="post" action="<?=base_url();?>laporan/laporan_izin.php" enctype="multipart/form-data" target="_blank">
