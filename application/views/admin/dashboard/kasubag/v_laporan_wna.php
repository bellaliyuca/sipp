...
<h3>Cetak Laporan Permohonan Tinggal WNA</h3>
<hr>

<div class="col-md-12 col-sm-12 col-xs-12">
<div class="x_panel">

	<h4> <i class="fa fa-book"> </i> &nbsp; Laporan  Surat Permohonan Tinggal  WNA </h4>
	<br>

    <form method="post" action="<?=base_url();?>laporan/laporan_wna.php" enctype="multipart/form-data" target="_blank">
