         ...
         <table id="datatable" class="table table-striped table-bordered">
            <thead>
             ...
             <?php foreach($data_balasan_ormas as $dt) : ?>
              ...
              <?php } else { ?>
              <form action="<?php echo base_url()?>admin/cetak_balasan_ormas" method="POST">
...
<!-- Modal Nomor Surat -->
 ...
 <?php foreach($data_balasan_ormas as $dt) : ?>
        ...
        <div class="modal fade" id="modal_no<?php echo $dt->id_balasan;?>" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form action ="<?php echo base_url()?>admin/update_no_ormas" method="POST">
                <!-- <input type="hidden" value="<?=$dt->id_surat_pengantar?>" name="id_surat"> -->
                <div class="modal-body  pr-4 pl-4">
                <input type="hidden" name="id_surat" value="<?=$dt->id_balasan?>">  
                <label>Nomor Surat :</label>
                <input type="text" name="no_surat" class="form-control" value="210/.../IV/VII.01/2020">  
                <br>
