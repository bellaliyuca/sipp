      ...
      <div class="x_title">
         <table id="datatable" class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <?php } else { ?>
              <form action="<?php echo base_url()?>admin/cetak_balasan_izin" method="POST">
...
<!-- Modal Nomor Surat -->
 ...
 <?php foreach($data_balasan_izin as $dt) : ?>
        ...
        <div class="modal fade" id="modal_no<?php echo $dt->id_balasan;?>" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form action ="<?php echo base_url()?>admin/update_no_izin" method="POST">
                <!-- <input type="hidden" value="<?=$dt->id_surat_pengantar?>" name="id_surat"> -->
                <div class="modal-body  pr-4 pl-4">
                <input type="hidden" name="id_surat" value="<?=$dt->id_balasan?>">  
                <label>Nomor Surat :</label>
                <input type="text" name="no_surat" class="form-control" value="070/.../III/VII.01/2020">  
                <br>
 ...
 <?php foreach($data_balasan_izin as $dt) : ?>
        ...
        <div class="modal fade" id="modal_tanggal<?php echo $dt->id_balasan;?>" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form action ="<?php echo base_url()?>admin/update_tgl_izin" method="POST">
                <!-- <input type="hidden" value="<?=$dt->id_surat_pengantar?>" name="id_surat"> -->
                <div class="modal-body  pr-4 pl-4">
                <input type="hidden" name="id_surat" value="<?=$dt->id_balasan?>">  
