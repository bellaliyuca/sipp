...
<!-- End Menu -->
        ...
        <div class="right_col" role="main">
          ...
          <?php if(is_array($cari_sumber_wna)){ ?>
             <?php $no = 1;?>
             <?php foreach($cari_sumber_wna as $b) {
             ...
             <?php } ?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo base_url()?>admin/simpan_balasan_wna"  method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control"  name="membaca" value= "<?=$sumber?>" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')" disabled>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="tembusan_5" placeholder="Isi Tembusan 5" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" class="form-control" name="tembusan_6" placeholder="Isi Tembusan 6" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                        </div>
                      </div>
