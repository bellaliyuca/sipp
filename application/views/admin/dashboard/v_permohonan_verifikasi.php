            ...
            <?php if(is_array($data_permohonan)){ ?>
             ...
             <tbody>
              ...
              <td class="center"> <?=$no?></td>
                 <td class="center"> <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_batal<?php echo $dt->id_surat_pengantar;?>"> <i class="fa fa-close"> </i></a></td> 
