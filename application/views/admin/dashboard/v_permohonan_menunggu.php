         ...
         <table id="datatable" class="table table-striped table-bordered">
            ...
            <?php if(is_array($data_permohonan)){ ?>
             ...
             <tbody>
              ...
              <td class="center"> <a class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal_verifikasi<?php echo $dt->id_surat_pengantar;?>"> <i class="fa fa-check"> </i></a></td> 
              ...
              <?php if ($dt->file_ktm == '') { ?>
                     ...
                     <td class="center"> 
              	    <?php if ($dt->jenis_surat == 'Lapor WNA'){?>
                        ...
                        <?php } else if ($dt->jenis_surat == 'Keberadaan Ormas') { ?>
                        <a href="<?php echo base_url().'/file/syarat_ormas/'.$dt->file_surat ?>" target="_BLANK"> <i class="fa fa-file"> </i> &nbsp;  Lihat Sura</a>
                        <?php } else if ($dt->jenis_surat == 'Izin Riset') { ?>
                        <a href="<?php echo base_url().'/file/syarat_izin/'.$dt->file_surat ?>" target="_BLANK"> <i class="fa fa-file"> </i> &nbsp; Lihat Sura</a>
                        <?php } ?>
                    </td>
...
<!-- Modal -->
 ...
 <?php foreach($data_permohonan as $dt) : ?>
        ...
        <div class="modal fade" id="modal_verifikasi<?php echo $dt->id_surat_pengantar;?>" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form action ="<?php echo base_url()?>admin/update_verifikasi" method="POST">
                <input type="hidden" value="<?=$dt->id_surat_pengantar?>" name="id_surat">
                <div class="modal-body  pr-4 pl-4">
                  <div class="radio">
                  <label style="font-weight: bold; font-size: 14px">  Verifikasi ?  
                    <label>
                    <input type="radio" class="flat" checked name="verifikasi" value="Verifikasi"> Verifikasi
                  </label>
                    <label>
                    <input type="radio" class="flat" name="verifikasi" value="Tidak Memenuhi Syarat"> Tidak Memenuhi Syarat
                  </label></label>
